...
public class GetQuoteItemProduct
{
    ...
    public class Handler : IRequestHandler<Query, Result<ProductLovDto>>
    {
        ...
        {
            var quoteItemProduct = (from itm in _context.QuoteItems
                    ...
                    where itm.QuoteId + itm.QuoteItemSeqId == request.QuoteItemId
            ...
            return Result<ProductLovDto>.Success(quoteItemProduct);
        }
    }
}