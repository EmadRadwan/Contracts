    ...
    public async Task<TrialBalanceContext> ComputeTrialBalance(string customTimePeriodId, string organizationPartyId)
    {
        ...
        try
        {
            if (!string.IsNullOrEmpty(customTimePeriodId))
            {
                ...
                {
                    /*if (organizationGlAccount.GlAccountId != "1211001")
                    {
...
// Helper method to avoid code duplication
        ...
        try
        {
            ...
            if (retainedEarningsAccount != null)
            {
                equities.Add(new GlAccountBalance
                {
                    ...
                    AccountName = retainedEarningsAccount.AccountNameArabic,
        ...
        foreach (var ts in transSums)
        {
            ...
            if (existing == null)
            {
                existing = new GlAccountBalance
                {
                    ...
                    AccountName = ts.AccountNameArabic,
                    D = 0,
                    C = 0,
                    Balance = 0
                };
        ...
        CustomTimePeriod lastClosedTimePeriod)
    {
        ...
        foreach (var row in openingTxRows)
        {
            ...
            bool isDebitAccount =
                await _acctgMiscService.IsDebitAccount(row.GlAccountId); // Reuse your existing service
