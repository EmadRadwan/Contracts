...
public class CreateExternalSalesManager
{
    ...
    public class Handler : IRequestHandler<Command, Result<PartyDto2>>
    {
        ...
        public async Task<Result<PartyDto2>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var roleType = await _context.RoleTypes.SingleOrDefaultAsync(
                x => x.RoleTypeId == "EXTERNAL_SALES_MANAGER", cancellationToken);
            ...
            var party = new Party
            {
                ...
                MainRole = "EXTERNAL_SALES_MANAGER",
            ...
            catch
            {
                ...
                return Result<PartyDto2>.Failure("Failed to create External Sales Manager");
            }

            return Result<PartyDto2>.Success(new PartyDto2
            {
                PartyId = newPartyId,
                Description = request.PartyDto.GroupName + " ( EXTERNAL_SALES_MANAGER )"
            });
        }
    }
}
