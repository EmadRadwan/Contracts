...
{
    public class Query : IRequest<IQueryable<VehicleRecord>>
    {
        public ODataQueryOptions<VehicleRecord> Options { get; set; }
    }


    public class Handler : IRequestHandler<Query, IQueryable<VehicleRecord>>
    {
        ...
        public async Task<IQueryable<VehicleRecord>> Handle(Query request, CancellationToken cancellationToken)
        {
