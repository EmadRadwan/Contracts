...
public class SeedMedications
{
        ...
        UserManager<AppUserLogin> userManager, RoleManager<ApplicationRole> roleManager)
    {
        ...
        {
            var path = Path.Combine(Directory.GetCurrentDirectory(), "Json/product_categories_medications.json");
            var jsonData = File.ReadAllText(path);
        ...
        {
            var path = Path.Combine(Directory.GetCurrentDirectory(), "Json/products_medications.json");
            var jsonData = File.ReadAllText(path);
        ...
        {
            var path = Path.Combine(Directory.GetCurrentDirectory(), "Json/product_assocs_medications.json");
            var jsonData = File.ReadAllText(path);
        ...
        {
            var path = Path.Combine(Directory.GetCurrentDirectory(), "Json/tax_authority_categories_medications.json");
            var jsonData = File.ReadAllText(path);
        ...
        {
            var path = Path.Combine(Directory.GetCurrentDirectory(), "Json/workefforts_medications.json");
            var jsonData = File.ReadAllText(path);
        ...
        {
            var path = Path.Combine(Directory.GetCurrentDirectory(), "Json/workeffort_assocs_medications.json");
            var jsonData = File.ReadAllText(path);
        ...
        {
            var path = Path.Combine(Directory.GetCurrentDirectory(), "Json/workeffort_good_standards_medications.json");
            var jsonData = File.ReadAllText(path);
        ...
        {
            var path = Path.Combine(Directory.GetCurrentDirectory(), "Json/workeffort_cost_calcs_medications.json");
            var jsonData = File.ReadAllText(path);
...
//---------------------------------Product Promo---------------------------------
        ...
        int agreementCounter = 300; // Initialize the counter starting at 300
        ...
        if (!context.Agreements.Any())
        {
            try
            {
                ...
                foreach (var party in partiesWithRoles)
                {
                    ...
                    {
                        // Generate AgreementId using the counter
                        var salesAgreementId = $"AG-{agreementCounter++:D6}";

                        // Create a Sales Agreement
                        var salesAgreement = new Agreement
                        {
                            AgreementId = salesAgreementId, // Use the counter-based ID
                        ...
                        {
                            AgreementTermId = salesAgreementId,
                            AgreementId = salesAgreementId,
                            TermTypeId = "FIN_PAYMENT_TERM",
                            TermValue = 1.0m,
                            TermDays = 30,
                    ...
                    {
                        // Generate AgreementId using the counter
                        var purchaseAgreementId = $"AG-{agreementCounter++:D6}";

                        // Create a Purchase Agreement
                        var purchaseAgreement = new Agreement
                        {
                            AgreementId = purchaseAgreementId, // Use the counter-based ID
                            PartyIdFrom = "Company",
                        ...
                        {
                            AgreementTermId = purchaseAgreementId,
                            AgreementId = purchaseAgreementId,
                            TermTypeId = "FIN_PAYMENT_TERM",
                            TermValue = 1.0m,
                            TermDays = 30,
