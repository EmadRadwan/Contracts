    ...
    public class Handler : IRequestHandler<Command, Results<IssueMaterialsForCertificateResult>>
    {
        ...
        public async Task<Results<IssueMaterialsForCertificateResult>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                // where WorkEffortId matches the provided ID. This ties certificate approval to successful material issuance,
                ...
                {
                    _logger.LogWarning("No PROJECT_CERTIFICATE found for WorkEffortId: {WorkEffortId}", request.WorkEffortId);
