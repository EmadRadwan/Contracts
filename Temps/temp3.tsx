...
const priceValidator = (
    ...
    if (
        (laborPrice === undefined || laborPrice === null) &&
        (materialPrice === undefined || materialPrice === null)
    ) {
...
const WorkmanshipContractingForm = ({
    ...
    const { total, deserved, insurance, additionalInsurance, net } = getTotals();

    const insuranceMode =
        (valueGetter("insuranceMode") as "value" | "percentage") ?? "value";
    const additionalInsuranceMode =
    ...
    useEffect(() => {
        ...
        const hasPrice =
            Number(valueGetter("materialPrice") || 0) +
            Number(valueGetter("laborPrice") || 0) >
            0;
        const isNewItem = editMode === 1;
        if (
            (curAch == null || curAch === "" || isNaN(Number(curAch))) &&
            hasPrice &&
            isNewItem
        ) {
    ...
    const descriptionLengthValidator = (
    ...
    const deductionDescriptionLengthValidator = (
        value: string | undefined
    ): string | undefined => {
                ...
                <Grid container spacing={1}>
                    ...
                    <Grid item xs={6}>
                        <Field
                            ...
                            label={getTranslatedLabel(
                                "projects.certificate.items.list.product",
                                "Product *"
                            )}
                    ...
                    <Grid item xs={2}>
                        <Field
                            ...
                            min={0}
                            validator={() =>
                                priceValidator(valueGetter("laborPrice"), valueGetter("materialPrice"))
                            }
                            disabled={formEditMode > 3}
                        />
                    </Grid>
                        ...
                        <Grid container direction="column" spacing={1}>
                            <Grid item>
                                <Field
                                    ...
                                    validator={
                                        insuranceMode === "percentage" ? percentageValidator : undefined
                                    }
                                    disabled={formEditMode > 3}
                                />
                            </Grid>
                            <Grid item>
                                ...
                                >
                                    <FormControlLabel
                                        ...
                                        label={getTranslatedLabel(
                                            "projects.certificate.items.list.insuranceValue",
                                            "Value"
                                        )}
                                    />
                                    <FormControlLabel
                                        ...
                                        control={<Radio disabled={formEditMode > 3} />}
                                        label={getTranslatedLabel(
                                            "projects.certificate.items.list.insurancePercentage",
                                            "Percentage"
                                        )}
                                    />
                                </RadioGroup>
                        ...
                        <Grid container direction="column" spacing={1}>
                            ...
                            <Grid item>
                                <RadioGroup
                                    ...
                                    onChange={(e) =>
                                        handleAdditionalInsuranceModeChange(e, formRenderProps.onChange)
                                    }
                                >
                                    <FormControlLabel
                                        value="value"
                                        control={<Radio disabled={formEditMode > 3} />}
                                        label={getTranslatedLabel(
                                            "projects.certificate.items.list.additionalInsuranceValue",
                                            "Value"
                                        )}
                                    />
                                    <FormControlLabel
                                        ...
                                        control={<Radio disabled={formEditMode > 3} />}
                                        label={getTranslatedLabel(
                                            "projects.certificate.items.list.additionalInsurancePercentage",
                                            "Percentage"
                                        )}
                                    />
                                </RadioGroup>
                    ...
                    {/* ---------- DEDUCTIONS SECTION (moved to the end) ---------- */}
                    {/* REFACTOR: Moved deductions and deductionDescription fields to the bottom of the form */}
                    {/* REFACTOR: This improves UX by letting users fill core item data first, then adjust deductions last */}
                    {/* REFACTOR: Grouped under a full-width row for visual separation */}
                    <Grid item xs={12}>
                        <Grid container spacing={1}>
                            <Grid item xs={2}>
                                <Field
