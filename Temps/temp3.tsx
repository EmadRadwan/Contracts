...
export default function PaymentForm({
    ...
    // REFACTOR: Simplify renderForm by removing EditPaymentApplications
    // Purpose: Move EditPaymentApplications to a ModalContainer for consistency with other modal-based components
    const renderForm = () => {
        if (formEditMode === 1) {
            if (paymentType === 1) {
                return (
    ...
    return (
        <RibbonContainer>
            ...
            <Paper elevation={5} className="div-container-withBorderCurved">
                ...
                {/* REFACTOR: Add ModalContainer for EditPaymentApplications */}
                {/* Purpose: Display EditPaymentApplications in a modal for better UX consistency */}
