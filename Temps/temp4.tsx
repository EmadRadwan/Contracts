...
// REFACTOR: Updated styles with fallback font for RTL support
// Improvement: Ensures proper rendering of Arabic text by specifying a fallback font
// Context: DejaVuSans may not fully support Arabic glyphs, causing text layout errors
const styles = StyleSheet.create({
    page: {
        flexDirection: 'column',
        padding: 20,
        fontFamily: 'Helvetica', // REFACTOR: Changed to Helvetica as a fallback for better RTL support
        textDirection: 'rtl',
        writingMode: 'rl-tb',
    },
    section: {
...
const CertificatePDFDocument: React.FC<CertificatePDFDocumentProps> = ({
    ...
    // REFACTOR: Added safe string conversion utility to prevent undefined errors
