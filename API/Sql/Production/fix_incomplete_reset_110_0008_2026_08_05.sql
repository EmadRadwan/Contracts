...
--
-- VERIFIED (2026-08-05, against a production data mirror): INV1379 is
-- INVOICE_IN_PROCESS, zero ACCTG_TRANS, zero PAYMENT_APPLICATION -- not
-- posted or paid, safe to remove outright. 8 ORDER_ITEM_BILLING rows, 1
-- ORDER_ADJUSTMENT_BILLING row, 9 INVOICE_ITEM, 4 INVOICE_ROLE, 1
-- INVOICE_STATUS. Already run and verified clean against the mirrored copy.
--
