...
import GlAccountTypeDefaults
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/GlAccountTypeDefaults";
...
import GlVarianceReason
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/GlVarianceReason";
...
import ForeignExchangeRatesList
    from "../../features/accounting/globalGlSetting/fxRates/dashboard/ForeignExchangeRatesList";
import SalesInvoiceAccountList
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/SalesInvoiceAccountList";
import PurchaseInvoiceAccountList
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/PurchaseInvoiceAccountList";
...
import ProductGlDefaults
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/ProductGlAccounts";
import ProductCategoryGlAccounts
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/ProductCategoryGlAccounts";
import FinAccountGlAccounts
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/FinAccountGlAccounts";
import PartyGlAccounts
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/PartyGlAccounts";
import PaymentMethodTypeGlAccounts
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/PaymentMethodTypeGlAccounts";
import PaymentTypeGlAccounts
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/PaymentTypeGlAccounts";
import CreditCardTypesGlAccounts
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/CreditCardTypesGlAccounts";
import TaxAuthorityGlAccounts
    from "../../features/accounting/organizationGlSettings/dashboard/glAccountDefaults/TaxAuthorityGlAccounts";
...
import ComparativeIncomeStatement
    from "../../features/accounting/organizationGlSettings/dashboard/ComparativeIncomeStatement";
import ComaparativeCashFlowStatement
    from "../../features/accounting/organizationGlSettings/dashboard/ComaparativeCashFlowStatement";
import ComparativeBalanceSheet
    from "../../features/accounting/organizationGlSettings/dashboard/ComparativeBalanceSheet";
...
import FinancialAccountTransactions
    from "../../features/accounting/financialAccount/dashboard/FinancialAccountTransactions";
import FinancialAccountDepositWithdrawal
    from "../../features/accounting/financialAccount/dashboard/FinancialAccountDepositWithdrawal";
...
// REFACTOR: Completely restructured route hierarchy to use RequireRole wrappers.
// This groups routes by module and applies role-based protection at the module level.
// Users without the required role are redirected to /not-found, preventing direct URL access.
// All original paths are preserved – no route is missed or removed.
        ...
        children: [
...

            {
                ...
                children: [
                    ...
                    // === Facility / Warehouse Module ===
                    {
                        element: <RequireRole allowedRoles="Facility_View"/>,
                        children: [
                    ...
                    // === Accounting Module ===
                    {
                        element: <RequireRole allowedRoles="Accounting_View"/>,
                        children: [
                            {path: "invoicesDashboard", element: <AccountingDashboard/>},
                            {
                                element: <RequireRole allowedRoles="Accounting_Invoices_View"/>,
                                children: [
                                    {
                                        path: "invoices",
                                        children: [
                            ...
                            {path: "glInitialBalance", element: <InitialBalanceTransForm/>},

                            // Billing & Financial Accounts (also accounting-related)
                            {
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    {
                                        path: "/financialAccounts/depositWithdraw",
                                        element: <FinancialAccountDepositWithdrawal/>
                                    },
                                ],
                            },
                    ...
                    // === Projects Module ===
                    {
                        element: <RequireRole allowedRoles="Projects_View"/>,
                        children: [
                    ...
                    // === Manufacturing Module (optional – add Manufacturing_View role if needed) ===
                    {
                        element: <RequireRole allowedRoles="Manufacturing_View"/>, // Create this role if you want to restrict
                        children: [
                    ...
                    // === Services Dashboard (if it needs separate access) ===
