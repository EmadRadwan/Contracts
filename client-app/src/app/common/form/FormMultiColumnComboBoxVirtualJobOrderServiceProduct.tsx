...
import {setProductId, setSelectedProduct} from "../../../features/orders/slice/jobOrderUiSlice";

export const FormMultiColumnComboBoxVirtualJobOrderServiceProduct = (
    ...
    const vehicleId = useAppSelector((state) => state.jobOrderUi.selectedVehicleId);
