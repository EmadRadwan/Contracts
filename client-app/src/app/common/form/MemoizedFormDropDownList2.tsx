...
export const FormDropDownList = (fieldRenderProps: FieldRenderProps) => {
    ...
    const onChangeHandler = React.useCallback(
        (event) => onChange({ value: event.value && event.value[dataItemKey] }),
    ...
    const selectedValue = data!.find((item: any) => item[dataItemKey] === value);
...
export const MemoizedFormDropDownList2 = React.memo(FormDropDownList);
