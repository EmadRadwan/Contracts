...
export const FormComboBoxVirtualGetPhysicalInventoryProductsLovProduct = (fieldRenderProps: FieldRenderProps) => {
    const {
        validationMessage,
        touched,
        onFocus,
    ...
    const requestData = React.useCallback((skip: number, filter: string) => {
        ...
        agent.Products.getPhysicalInventoryProductsLov(params)
            .then((json) => {
                if (json) {
