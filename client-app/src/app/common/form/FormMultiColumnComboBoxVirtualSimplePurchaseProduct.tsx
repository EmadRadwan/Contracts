...
export const FormMultiColumnComboBoxVirtualSimplePurchaseProduct = (fieldRenderProps: FieldRenderProps) => {
    const {
        validationMessage,
        touched,
        onFocus,
    ...
    const columns = [
        ...
        {field: "uomDescription", header: "UOM"},
    ];
    ...
    const requestData = React.useCallback((skip: number, filter: string) => {
        ...
        agent.Products.getSimplePurchaseProductsLov(params)
            .then((json) => {
                if (json) {
