...
export const FormMultiColumnComboBoxVirtualFinishedProduct = (
    ...
    const columns = [{field: "productName", header: "Product", width: columnWidth}];
    ...
    const requestData = React.useCallback((skip: number, filter: string) => {
        ...
        agent.Products.getFinishedProductsLov(params).then((json) => {
            if (json) {
