...
export const FormMultiColumnComboBoxVirtualAssocsProduct = (fieldRenderProps: FieldRenderProps) => {
    const {
        validationMessage,
        touched,
        onFocus,
    ...
    const productId = selectedProduct ? selectedProduct.productId : undefined;
    ...
    const requestData = React.useCallback((skip: number, filter: string) => {
        ...
        agent.Products.getAssocsProductsLov(params)
            .then((json) => {
                if (json) {
