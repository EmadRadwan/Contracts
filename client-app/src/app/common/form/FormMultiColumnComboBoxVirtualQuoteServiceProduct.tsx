...
import {setProductId, setSelectProductOrService} from "../../../features/orders/slice/sharedOrderUiSlice";
...
export const FormMultiColumnComboBoxVirtualQuoteServiceProduct = (
    ...
    const columns = [
        ...
        {field: "availableToPromiseTotal", header: "ATP", width: "70px"},
        {field: "price", header: "Price", width: "70px"},
        {field: "uomDescription", header: "Uom", width: "190px"},
        // {field: "listPrice", header: "ListPrice", width: "0px"},
        {field: "facilityName", header: "Facility", width: "160px"},
    ];
    ...
    const onChangeHandler = React.useCallback(
        (event) => {
            if (event.value === null) {
                ...
                dispatch(setSelectProductOrService(undefined));
            } else {
                dispatch(setProductId(event.value.productId));
                dispatch(setSelectProductOrService(event.value));
            }
