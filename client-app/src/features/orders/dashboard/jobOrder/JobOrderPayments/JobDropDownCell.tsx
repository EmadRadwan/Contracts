...
import {useFetchPaymentMethodTypesQuery} from "../../../../../app/store/apis";

export const JobDropDownCell = (props: GridCellProps) => {
    const {data: paymentMethodTypesData} = useFetchPaymentMethodTypesQuery(undefined);
    ...
    const localizedData = paymentMethodTypesData ? paymentMethodTypesData.map((pmt: any) => {
        return {text: pmt.label, value: pmt.value}
    }) : [];
