...
export default function JobQuotesList() {
    ...
    const {data, isFetching} = useFetchQuotesQuery({...dataState});
    ...
    function handleSelectQuote(quoteId: string, quoteStatus: string) {
        ...
        dispatch(setVehicleId(selectedQuote?.vehicleId.vehicleId));
        dispatch(setSelectedVehicle(selectedQuote?.vehicleId));
