                ...
                <Table size="small">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell>{getTranslatedLabel("accounting.payroll.run.base-salary", "Base Salary")}</TableCell>
                            <TableCell>{getTranslatedLabel("accounting.payroll.run.salary-account", "Salary Account")}</TableCell>
                            <TableCell>{getTranslatedLabel("accounting.payroll.run.advance-account-id", "Advance Acc ID")}</TableCell>
                            <TableCell>{getTranslatedLabel("accounting.payroll.run.advance-account-name", "Advance Acc Name")}</TableCell>
                    ...
                    <TableBody>
                        {payrollData.map((emp, index) => (
                            <TableRow key={emp.employeeId}>
                                ...
                                <TableCell>{emp.baseSalary}</TableCell>
                                <TableCell>{emp.salaryAccountNameArabic}</TableCell>
                                <TableCell>{emp.glAccountIdAdvancedPayment}</TableCell>
                                <TableCell>{emp.advancedPaymentAccountNameArabic}</TableCell>
                                <TableCell>
