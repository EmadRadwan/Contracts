...
const OrgGlSettingsMenuNavContainer = (props: any) => {
...
const links = [
    {title: 'Create a GL Transaction', path: '/createAGlTransaction', key: "createGL"},
    {title: 'Create New Invoice', path: '/createNewInvoice', key: "createInv"},
    {title: 'Create New Payment', path: '/createNewPayment', key: "createPmt"},

];


export default withRouter(OrgGlSettingsMenuNavContainer)
