        ...
        <>
            ...
            <Paper elevation={5} className="div-container-withBorderCurved">
                ...
                >
                    ...
                    <Column field="usedBalance" title="الرصيد المستخدم" format="{0:n2}" filter={"numeric"} />
                    <Column field="remainingBalance" title="الرصيد المتبقي" format="{0:n2}" filter={"numeric"} />
