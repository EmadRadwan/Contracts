...
const BillingAccountsMenuNavContainer = (props: any) => {
...
const links = [
    {title: 'Account', path: '/billingAccounts', key: "acc"},
    {title: 'Invoices', path: '/billingAccounts/invoices', key: "inv"},
    {title: 'Payments', path: '/billingAccounts/payments', key: "pmt"},
    {title: 'Orders', path: '/billingAccounts/orders', key: "order"}
];


export default withRouter(BillingAccountsMenuNavContainer)
