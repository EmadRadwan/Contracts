...
const PaymentGroupMenuNavContainer = (props: any) => {
...
const links = [
    {title: 'Overview', path: '/paymentGroups/overview', key: "ov"},
    {title: 'Payments', path: '/paymentGroups/payments', key: "pmt"},
...
export default withRouter(PaymentGroupMenuNavContainer)
