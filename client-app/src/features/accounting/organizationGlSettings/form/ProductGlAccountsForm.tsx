...
import { useFetchGlAccountTypesQuery, useFetchOrganizationGlChartOfAccountsQuery } from '../../../../app/store/apis'
...
const ProductGlAccountsForm = ({selectedAccountingCompanyId, onSubmit}: Props) => {
  ...
  console.log('formattedGlAccounts', formattedGlAccounts)
...
export default ProductGlAccountsForm