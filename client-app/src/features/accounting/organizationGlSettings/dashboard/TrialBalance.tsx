            ...
            <Grid container>
              <div className="div-container">
                ...
                >
                  ...
                  <Column field="postedCredits" title={getTranslatedLabel(`${localizationKey}.postedCredits`, "Credit")} format="{0:n2}" filter={"numeric"} />
                  <Column field="endingBalance" title={getTranslatedLabel(`${localizationKey}.endingBalance`, "Ending Balance")} format="{0:n2}" filter={"numeric"} />
                </KendoGrid>
              </div>
            </Grid>
          )}
