...
const FinAccountGlAccounts = () => {
    ...
    const { data: finAccountGlAccounts } =
    useFetchFinAccountGlAccountsQuery(selectedAccountingCompanyId, {
            skip: selectedAccountingCompanyId === undefined,
        });
    console.log(finAccountGlAccounts)
    ...
    <>
        ...
        <Grid item xs={8}>
          <Paper elevation={5} className={`div-container-withBorderCurved`}>
            <FinAccountGlAccountsForm selectedAccountingCompanyId={selectedAccountingCompanyId} onSubmit={onSubmit} />

            <div className="div-container">
              <KendoGrid
                data={orderBy(
                    finAccountGlAccounts ? finAccountGlAccounts : [],
                    sort
              ...
              >
                <Column
                  field="finAccountTypeDescription"
...
export default FinAccountGlAccounts