...
import {
    Grid as KendoGrid, GridCellProps,
...
import { useFetchPaymentMethodTypeGlAccountsQuery } from '../../../../../app/store/apis/accounting/paymentMethodTypeGlAccountsApi';
import PaymentMethodTypeGlAccountForm from '../../form/PaymentMethodTypeGlAccountForm';
import Button from "@mui/material/Button";
import {OrderAdjustment} from "../../../../../app/models/order/orderAdjustment";

const PaymentMethodTypeGlAccounts = () => {
    ...
    const { data: paymentMethodTypeAccounts } =
    useFetchPaymentMethodTypeGlAccountsQuery(selectedAccountingCompanyId, {
            skip: selectedAccountingCompanyId === undefined,
        });
    // console.log(paymentMethodTypeAccounts)
...
export default PaymentMethodTypeGlAccounts