...
const errorMessages: Record<string, Record<string, string>> = {
  en: {
    ...
    USE_RESET_ACTION: "Use the Reset action to move a Received/Sent payment back to Not Paid.",
  ...
  ar: {
    ...
    USE_RESET_ACTION: "استخدم إجراء إعادة التعيين لإرجاع دفعة مستلمة/مرسلة إلى غير مدفوع.",
