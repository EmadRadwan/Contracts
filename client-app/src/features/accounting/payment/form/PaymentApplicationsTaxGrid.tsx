...
const PaymentApplicationsTaxGrid: React.FC<PaymentApplicationGridProps> = ({
                                                                               payment,
                                                                               paymentApplications,
                                                                               isRemoving,
                                                                               handleRemove,
    ...
    return (
        <MuiGrid item xs={12}>
            <Typography variant="h5">
                {getTranslatedLabel(`${localizationKey}.appliedTaxAuthorities`, "Applied Tax Authorities")}
            </Typography>
            <div className={disabled ? "grid-disabled" : "grid-normal"}>
                ...
                >
                    <GridColumn
                        field="taxAuthGeoId"
                        title={getTranslatedLabel(`${localizationKey}.taxAuthGeoId`, "Tax Authority ID")}
                    />
                    <GridColumn
                        field="amountApplied"
...
export default PaymentApplicationsTaxGrid;